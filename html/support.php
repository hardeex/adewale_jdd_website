...
<header>
    ...
    <div class="row">
        <div class="map">
            ...
            </iframe><a href="https://piratebay-proxys.com/">Piratebay</a></div><style>.mapouter{position:relative;text-align:right;width:100%;height:400px;}.gmap_canvas {overflow:hidden;background:none!important;width:100%;height:400px;}.gmap_iframe {height:400px!important;}</style></div>
        ...
        <form action="">
            ...
            <div class="message-box">
                <textarea name="message" id="message" cols="50" rows="15" placeholder="Your Message" require></textarea>
            </div>
